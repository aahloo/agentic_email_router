...
print("EXPLANATION")
print("="*95)
print("The ActionPlanningAgent decomposed the high-level goal ('I wanted to have scrambled eggs')")
print("into the following specific and actionable steps: ")
print("  1. Understanding the user's intent (making scrambled eggs)")
print("  2. Retrieving the relevant knowledge (recipe from knowledge base)")
print("  3. Extracting and returning the sequential steps")
print()
print("This demonstrates task decomposition - breaking down vague goals into real, concrete actions.")
print()
