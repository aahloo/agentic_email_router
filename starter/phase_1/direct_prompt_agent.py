...
print("DirectPromptAgent uses the LLM's pretrained knowledge to answer questions.")
print("No additional context, system prompts, or external knowledge is provided.")
print("The agent simply passes the user's prompt directly to the gpt-3.5-turbo model,")
print("which responds based on its training data from before its knowledge cutoff date.")
